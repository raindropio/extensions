var {extension, getSetting, sendMessageToBackground} = require('../extension').default

const 	dragAreaID = "raindrop-drag-area",
		dragDisabledKey = "drag-disabled";
...
const Drag = {
	...
	render() {
		getSetting('drag-disabled')
			.then((isDisabled)=>{
				if (isDisabled) this.showing = false;
